...
class FullFlex:
    ...
    def train(self, args, logger=None):
        ...
        selected_label = F.ones((len(self.ulb_dset),), dtype='int32') * (-1)
        classwise_acc = F.zeros(args.num_classes, dtype='float32')
        ...
        if args.resume:
            ...
            selected_label = mge.tensor(pickle.load(open(os.path.join(save_path, 'selected_label_{}.pkl'.format(args.gpu)), 'rb')))
